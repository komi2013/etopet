...
// 素材(必要になりそうなやつ)
var KUMA_IMAGE_PATH      = "/public/game/stg2/chara2.gif"; // プレイヤーイメージ
    ...
    scene.onenter = function() {
      ...
      if (time < 10) {
  	  ...
  	  if (time <= 0) {
    		...
    		if (score > 1000) message += "msg2";
    		game.end(score, message);
        
        var hash_score = CryptoJS.HmacSHA256(String(score), hash_key);
//         var hash_score = make_hash_score(score);
        window.location.replace('/en/in/score/' + hash_score + '/');
  	  }
