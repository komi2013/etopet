...
var damage_wav = '/public/game/puzzle/damage.wav';
var win_wav = '/public/game/puzzle/win.wav';
var bgm = '/public/game/puzzle/bgm02.wav';
...
window.onload = function() {
	...
	game.fps = 15;
	game.score = 0;
	game.preload(panel_png,bingo_wav,combo_wav,bomb,damage_wav,bgm,win_wav);
    ...
    var seWin = game.assets[win_wav].clone();
...
//           attack(thisComboCount);
          ...
          if(enemy_hp < 1){
            ...
            window.location.replace('/'+lang+'/rank/beat/');
          }else if(my_hp < 1){
//             var damage = start_enemy_hp - enemy_hp; 
            var post_q_txt = '/en/in/puzzle/';
            var param2 = {
            ...
            game.end(maxComboCount, 'MAX COMBO: ' + maxComboCount);
            alert(Math.floor(damage)+' damage');
