 ...
 * @usage
 ...
 core.start();
 */                
var start_png = '/public/game/puzzle/start.png';
var end_png = '/public/game/puzzle/end.png';
...
(function() {
     ...
     * @type {Object}
     */
    enchant.nineleap = { assets: [start_png, end_png] };
    ...
    enchant.nineleap.Core = enchant.Class.create(enchant.Core, {
        ...
        initialize: function(width, height) {
            ...
            this.addEventListener('load', function() {
                ...
                this.startScene.image = this.assets[start_png];
                ...
                this.endScene.image = this.assets[end_png];
